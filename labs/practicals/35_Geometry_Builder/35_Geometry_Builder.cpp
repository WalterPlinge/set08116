...
bool load_content ( )
{
  ...
  meshes["tetra"].get_transform ( ).scale = vec3 ( 4 );
  ...
  meshes["disk"].get_transform ( ).orientation = eulerAngleX ( pi<float> ( ) / 2 );
  ...
  meshes["torus"].get_transform ( ).orientation = eulerAngleX ( pi<float> ( ) / 2 );
