...
#define NapierGreen 0.196f, 0.765f, 0.082f
...
// Set the colour value for the shader here  (Hint: rep the Brand, use the NapierRed macro )
	glUniform4fv( eff.get_uniform_location ( "colour_one" ), 1, value_ptr( vec4 ( NapierRed, 1 ) ) );
  glUniform4fv ( eff.get_uniform_location ( "colour_two" ), 1, value_ptr ( vec4 ( NapierGreen, 1 ) ) );
// *********************************
